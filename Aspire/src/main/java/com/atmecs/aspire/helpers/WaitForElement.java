...
public class WaitForElement {
	...
	public WebElement waitForElementToBeClickable(WebDriver driver,String locator) 
	{
		...
		return wait.until(ExpectedConditions.elementToBeClickable(GetElementFromLocators.matchLocatorsAndFetchElement(locator, driver)));
	}
	...
	{
		WebDriverWait wait=new WebDriverWait(driver,FileConstant.EXPLICIT_WAIT);
		wait.until(ExpectedConditions.elementToBeSelected(GetElementFromLocators.matchLocatorsAndFetchElement(locator, driver)));
	}
	...
	{
		WebDriverWait wait=new WebDriverWait(driver,FileConstant.EXPLICIT_WAIT);
		wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(GetElementFromLocators.matchLocatorsAndFetchElement(locator, driver)));
	}
